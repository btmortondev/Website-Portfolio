    ...
    <div className="about-content">
      ...
      <div className="about-first-fold">
        ...
        <p className="about-description">
          ...
          Youngstown State University. Frontend development is what I'm looking
          to do for work and all of the skills and knowledge I have applicable
          is self taught. I currently live in Youngstown, OH and would
          eventually like to move away. Remote work or somewhere that is
          reasonable to comute would be great!
        </p>
      </div>
